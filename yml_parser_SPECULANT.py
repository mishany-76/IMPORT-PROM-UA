...
class FeedProcessor:
    ...
    def _batch_update_rows(self, sheet_name: str, updates: List[Tuple[int, List]], headers: List[str]):
        ...
        """
        # Only check critical fields for products sheet
        ...
        for batch_idx, batch in enumerate(batches):
            ...
            data = []
            for row_idx, row_data in batch:
                # For products sheet, check critical fields
...
if __name__ == "__main__":
    # Configuration
    SPREADSHEET_ID = "10GesfoS_QWL_oFFlk-W9HBuOzHIuKd7ylF9h2v-xfMs"  # Replace with your actual spreadsheet ID

    FEEDS = [
        "https://spekylant.com.ua/products_feed.xml?hash_tag=b8e062c91c974da19411c639763748b5&sales_notes=&product_ids=&label_ids=&exclude_fields=&html_description=1&yandex_cpa=&process_presence_sure=&languages=uk%2Cru&extra_fields=&group_ids=53533543%2C83509800&nested_group_ids=53533543%2C83509800",
